...
def formatiere_anzeige_df(df):
    ...
    rename_map = {
        ...
        "Intraday Beste Kaufzeit": "Kaufzeit DE",
        "Intraday Beste Verkaufszeit": "Verkauf DE",
        "Day Buy-in Zeit": "Buy-in DE (D)",
        "Day Take-Profit Zeit": "TP-Zeit DE (D)",
        "Swing Buy-in Zeit": "Buy-in DE (S)",
        "Swing Take-Profit Zeit": "TP-Zeit DE (S)",
        "Day Optimiert Buy-in Zeit": "Opt Buy (D)",
        "Day Optimiert Take-Profit Zeit": "Opt TP (D)",
        "Swing Optimiert Buy-in Zeit": "Opt Buy (S)",
        "Swing Optimiert Take-Profit Zeit": "Opt TP (S)",
        "Day Optimiert Trefferquote %": "Opt Hit (D)",
        "Swing Optimiert Trefferquote %": "Opt Hit (S)",
